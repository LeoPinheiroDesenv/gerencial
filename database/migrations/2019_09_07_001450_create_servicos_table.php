...
class CreateServicosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('servicos', function (Blueprint $table) {
            ...
            $table->string('cnae_servico', 10)->nullable();
            $table->decimal('aliquota_iss', 6, 2)->default(0);
            $table->decimal('valor_aliquota', 6, 2)->default(0);
            $table->decimal('aliquota_pis', 6, 2)->default(0);
            $table->decimal('aliquota_cofins', 6, 2)->default(0);
            $table->decimal('aliquota_inss', 6, 2)->default(0);
