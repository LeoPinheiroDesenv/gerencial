...
class CreateItemPedidoMesasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('item_pedido_mesas', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->foreign('pedido_id')->references('id')->on('pedido_mesas')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('item_pedido_mesas');
    }
}
