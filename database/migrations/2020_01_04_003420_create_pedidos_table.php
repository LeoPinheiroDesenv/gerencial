...
class CreatePedidosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('pedidos', function (Blueprint $table) {
            ...
            // alter table pedidos add column cliente_id integer default null;
            ...
            $table->boolean('catraca_aberta')->default(0);
            $table->boolean('catraca_fechada')->default(0);

            // alter table pedidos add column catraca_aberta boolean default 0;
            // alter table pedidos add column catraca_fechada boolean default 0;
