...
class CreatePlanosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('planos', function (Blueprint $table) {
            ...
            $table->boolean('api_sieg')->default(0);
            $table->boolean('visivel_representante')->default(0);

            // alter table planos add column armazenamento integer default 0;
            // alter table planos add column maximo_nfse integer default 0;
            // alter table planos add column api_sieg boolean default 0;
            // alter table planos add column visivel_representante boolean default 0;
            $table->timestamps();
        });
    }
