...
class CreateNfsesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('nfses', function (Blueprint $table) {
            ...
            // alter table nfses add column chave varchar(50) default null;

            // alter table nfses add column nome_fantasia varchar(60) default null;
