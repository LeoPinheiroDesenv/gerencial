...
class CreateItemRemessaNvesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('item_remessa_nves', function (Blueprint $table) {
            ...
            $table->foreign('remessa_id')->references('id')->on('remessa_nves')->onDelete('cascade');
            ...
            // alter table item_remessa_nves add column produto_nome varchar(100) default null;
