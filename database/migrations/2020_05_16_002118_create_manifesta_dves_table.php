...
class CreateManifestaDvesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('manifesta_dves', function (Blueprint $table) {
            ...
            $table->integer('venda_id')->deafult(0);
            ...
            // alter table manifesta_dves add column venda_id integer default 0;
            // alter table manifesta_dves add column filial_id integer default null;
