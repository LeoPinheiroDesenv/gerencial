...
class CreateDevolucaosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('devolucaos', function (Blueprint $table) {
            ...
            // alter table devolucaos add column transportadora_id integer default null;
            ...
            $table->decimal('vbc_manual', 10, 2)->default(0);
            ...
            // alter table devolucaos add column altera_manual boolean default 0;
            // alter table devolucaos add column vbc_manual decimal(10,2) default 0;
            // alter table devolucaos add column filial_id integer default null;
