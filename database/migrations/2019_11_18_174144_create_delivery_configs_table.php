...
class CreateDeliveryConfigsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('delivery_configs', function (Blueprint $table) {
            ...
            // alter table delivery_configs add column api_token varchar(50) default null;
            // alter table delivery_configs add column descricao varchar(200) default '';
            // alter table delivery_configs add column nome varchar(30) default '';
            // alter table delivery_configs add column valor_entrega_gratis integer default 0;


            // alter table delivery_configs add column cidade_id integer default null;
