...
class ComprovanteTransferencia extends Common
{
    protected $papel;
    ...
    protected function pProdutosDANFE($x = 0, $y = 0, $h = 0)
    {
        ...
        $texto = $this->transferencia->produto->nome;
        $this->pTextBox(
            $xBoxDescricao,
            $y,
            $wBoxDescricao,
    ...
    protected function pTotalDANFE($x = 0, $y = 0, $h = 0)
    {
        ...
        $texto = "Produto: " . $this->transferencia->produto->nome;
        $aFont = array('font'=>$this->fontePadrao, 'size'=>7, 'style'=>'B');
        $this->pTextBox($x, $y, $wColEsq+20, $hLinha, $texto, $aFont, 'T', 'L', 0, '', false);
        // $texto = $this->transferencia->produto->nome;
        // $aFont = array('font'=>$this->fontePadrao, 'size'=>7, 'style'=>'B');
        ...
        $texto = number_format($this->transferencia->quantidade, 3, ',', '.');
        $aFont = array('font'=>$this->fontePadrao, 'size'=>7, 'style'=>'B');
        ...
        $aFont = array('font'=>$this->fontePadrao, 'size'=>7, 'style'=>'B');
        $this->pTextBox($x, $yTotal, $wColEsq, $hLinha, $texto, $aFont, 'T', 'L', 0, '', false);
        $texto = $this->transferencia->filial_saida ? $this->transferencia->filial_saida->descricao : 'Matriz';
        $aFont = array('font'=>$this->fontePadrao, 'size'=>7, 'style'=>'B');
        $this->pTextBox($xValor, $yTotal, $wColDir, $hLinha, $texto, $aFont, 'T', 'R', 0, '', false);
        $yTotal = $yTotal + ($hLinha);
        ...
        $aFont = array('font'=>$this->fontePadrao, 'size'=>7, 'style'=>'B');
        $this->pTextBox($x, $yTotal, $wColEsq, $hLinha, $texto, $aFont, 'T', 'L', 0, '', false);
        $texto = $this->transferencia->filial_entrada ? $this->transferencia->filial_entrada->descricao : 'Matriz';
        $aFont = array('font'=>$this->fontePadrao, 'size'=>7, 'style'=>'B');
        $this->pTextBox($xValor, $yTotal, $wColDir, $hLinha, $texto, $aFont, 'T', 'R', 0, '', false);
        $yTotal = $yTotal + ($hLinha);
        ...
        $this->pTextBox($x, $yTotal, $wColEsq, $hLinha, $texto, $aFont, 'C', 'L', 0, '', false);

        $yTotal = $yTotal + $hLinha;
        $texto = $this->transferencia->usuario->nome . " - " . date('d/m/Y H:i');
        $this->pTextBox($x, $yTotal, $wColDir+10, $hLinha, $texto, $aFont, 'C', 'L', 0, '', false);
