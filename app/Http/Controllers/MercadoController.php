...
use App\Models\BannerTopo;
use App\Models\BannerMaisVendido;
...
class MercadoController extends Controller
{
    ...
    public function index(){
        ...
        $deliveryLancheAtivo = env('DELIVERY');
        $deliveryMercadoAtivo = env('DELIVERY_MERCADO');
...
public function enviarSenha(Request $request){
    ...
    if($cliente == null){
        ...
        if(env("AUTENTICACAO_EMAIL") == 1 && env("SERVIDOR_WEB") == 1) {
