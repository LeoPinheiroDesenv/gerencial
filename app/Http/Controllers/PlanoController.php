...
class PlanoController extends Controller
{
	...
	public function save(Request $request){
		...
		$request->merge([ 'maximo_usuario_simultaneo' => $request->maximo_usuario_simultaneo ?? 0]);
		$request->merge([ 'armazenamento' => $request->armazenamento ?? 0]);
        $request->merge([ 'visivel' => $request->visivel ? true : false ]);
        $request->merge([ 'visivel_representante' => $request->visivel_representante ? true : false ]);
        $request->merge([ 'api_sieg' => $request->api_sieg ? true : false ]);
	...
	public function update(Request $request){
		...
		$plano->maximo_nfse = $request->maximo_nfse;
		...
		$plano->visivel_representante = $request->visivel_representante ? true : false;
		$plano->api_sieg = $request->api_sieg ? true : false;
	...
	private function _validate(Request $request){
		...
		$messages = [
			...
			'maximo_nfse.required' => 'Campo obrigatório.',
