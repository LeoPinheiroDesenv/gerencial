...
<div class="card card-custom gutter-b">
	...
	<div class="card-body">
		...
		<div class="@if(env('ANIMACAO')) animate__animated @endif animate__backInRight" id="kt_user_profile_aside" style="margin-left: 10px; margin-right: 10px;">
			<form method="get" action="/veiculos/filtro">
				<div class="row align-items-center">

					
					<div class="col-md-2">
						<label>Placa</label>
						<input type="text" value="{{ isset($placa) ? $placa : '' }}" name="placa" class="form-control" data-mask="AAA-0A00">
					</div>

					<div class="col-md-2">
						<label>Marca</label>
						<input type="text" value="{{ isset($marca) ? $marca : '' }}" name="marca" class="form-control">
					</div>

					<div class="col-md-2">
						<label>Modelo</label>
						<input type="text" value="{{ isset($modelo) ? $modelo : '' }}" name="modelo" class="form-control">
					</div>
										...
										<table class="datatable-table" style="max-width: 100%; overflow: scroll">
											<thead class="datatable-head">
												<tr class="datatable-row" style="left: 0px;">
													...
													<th data-field="OrderID" class="datatable-cell datatable-cell-sort"><span style="width: 150px;">PLACA</span></th>
											...
											<tbody id="body" class="datatable-body">
												...
												<tr class="datatable-row">
													...
													<td class="datatable-cell"><span class="codigo" style="width: 150px;" id="id">{{$v->placa}}</span>
													</td>
													...
													<td class="datatable-cell">
														<span class="codigo" style="width: 200px;" id="id">
															<a class="btn btn-warning btn-sm" onclick='swal("Atenção!", "Deseja editar este registro?", "warning").then((sim) => {if(sim){ location.href="/veiculos/edit/{{ $v->id }}" }else{return false} })' href="#!">
																<i class="la la-edit"></i>	
															</a>
															<a class="btn btn-danger btn-sm" onclick='swal("Atenção!", "Deseja remover este registro?", "warning").then((sim) => {if(sim){ location.href="/veiculos/delete/{{ $v->id }}" }else{return false} })' href="#!">
									...
									<div class="card card-custom gutter-b example example-compact">
										...
										<div class="card-body">
											...
											<div class="kt-widget__info">
												...
												<a class="kt-widget__data text-success">{{$c->placa}}</a>
											</div>
											<div class="kt-widget__info">
