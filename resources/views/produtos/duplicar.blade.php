									...
									<div class="pb-5" data-wizard-type="step-content">
										<div class="row">
											...
											<div class="col-xl-12">
													...
													<div class="form-group validated col-sm-6 col-lg-3">
														...
														<div class="col-6">
															<span class="switch switch-outline switch-primary">
																<label>
																	<input value="true" @if(isset($produto) && $produto->gerenciar_estoque) checked @elseif(env("PRODUTO_GERENCIAR_ESTOQUE") == 1 && !isset($produto)) checked @endif type="checkbox" name="gerenciar_estoque" id="gerenciar_estoque">
																	<span></span>
																</label>
															</span>
														</div>
												...
												<div class="col-12 div_info_composto" style="display: none;">
													<div class="row">
														<div class="form-group validated col-12">
															<label class="col-form-label">Informação tecnica</label>

															<textarea class="form-control" name="info_tecnica_composto" id="info_tecnica_composto" style="width: 100%; height:250px;">@isset($produto){{$produto->info_tecnica_composto}}@else{{old('info_tecnica_composto')}}@endif
															</textarea>
														</div>
													</div>
												...
												<div class="form-group validated col-12">
													...
													<span class="switch switch-outline switch-info">
														<label>
															<input @isset($produto) @if($produto->perc_glp != 0) checked @endif @endisset @if(old('der_petroleo')) checked @endif
												...
												@if(!isset($produto) && env("ECOMMERCE") == 1)
												<div class="form-group validated col-sm-6 col-lg-3">
									...
									<div class="col-xl-12">
										<div class="row">
											...
											<div class="form-group validated col-sm-3 col-lg-2">
												...
												<div class="">
													<input type="text" id="pDif" class="form-control @if($errors->has('pDif')) is-invalid @endif" name="pDif" 
...
<script type="text/javascript">
	...
	function tpComposto(){
		if($('#composto').is(':checked')){
			$('.div_info_composto').css('display', 'block')
		}else{
