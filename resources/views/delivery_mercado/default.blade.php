                    ...
                    <ul class="rd-navbar-modern-contacts">
                      ...
                      <li>
                        <div class="unit unit-spacing-sm">
                          ...
                          <div class="unit-body"><a class="link-email" href="mailto:{{env('MAIL_USERNAME')}}">{{env('MAIL_USERNAME')}}</a></div>
                        </div>
                      </li>
                    </ul>
                ...
                <div class="col-md-10 col-xxl-6">
                  <div class="slider-modern-box">
                    ...
                    <div class="oh button-wrap">
                      ...
                      <a class="button button-{{env('COLOR_BUTTON')}} button-ujarak" href="/delivery/produto/{{$b->produto->id}}" data-caption-animate="slideInLeft" data-caption-delay="400">Ver Produto</a>

                      @elseif($b->pack_id != null)
                      <a class="button button-{{env('COLOR_BUTTON')}} button-ujarak" href="/delivery/pack/{{$b->pack->id}}" data-caption-animate="slideInLeft" data-caption-delay="400">Ver Promoção</a>
                      @endif
                    </div>
                  </div>
                </div>
        ...
        <div class="footer-variant-2-bottom-panel">
          <div class="container">
            ...
            <div class="group-sm group-sm-justify">
              <p class="rights"><span>&copy;&nbsp;</span><span class="copyright-year"></span> <span>Owner</span>.
              </p>
              <p class="rights">Design&nbsp;by&nbsp;<a href="https://www.templatemonster.com/">Owner</a></p>
            </div>
          </div>
        </div>
      </footer>
