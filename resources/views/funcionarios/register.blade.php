								...
								<div class="kt-section__body">
									...
									<div class="row">
										...
										<div class="form-group validated col-sm-8 col-lg-2">
											...
											<div class="">
												<input id="data_nascimento" type="text" class="form-control @if($errors->has('data_nascimento')) is-invalid @endif" data-mask="00/00/0000" name="data_nascimento" value="{{{ isset($funcionario) ? __date($funcionario->data_nascimento, 0) : old('data_nascimento') }}}">
											</div>
										</div>
