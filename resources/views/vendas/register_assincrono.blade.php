										...
										<div class="">
											<div class="input-group date">
												<select class="custom-select form-control" id="vendedor_id" name="vendedor_id">
													...
													<option @if($config->gerenciar_comissao_usuario_logado == 1 && $v->id == $usuario->id) selected @endif value="{{$v->id}}">{{$v->funcionario->nome}}</option>
													@endforeach
												</select>
											</div>
										</div>
								...
								<div class="row">
									<div class="form-group validated col-md-6 col-12">
										...
										<div class="input-group">
											...
											<select class="form-control select2 cliente_select2" id="kt_select2_3" name="cliente">
															...
															<div class="row align-items-center">
																<div class="form-group validated col-sm-6 col-lg-6 col-12">
																	...
																	<div class="input-group">
																		...
																		<select class="form-control select2 produto-search select-search" style="width: 86%" name="produto-search">
				...
				<div class="card card-custom gutter-b">
					...
					<div class="card-body">
						<div class="row">
							...
							<div class="form-group col-xl-2 col-sm-6 col-6">
							...
							<div class="form-group col-xl-2 col-sm-6 col-6">
								...
								<input type="text" name="data_venda" class="form-control date-input" value="" 
								id="data_venda"/>
							</div>
						</div>
						<div class="row">
