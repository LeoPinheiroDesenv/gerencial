...
<div class="card card-custom gutter-b">
	<div class="card-body">
		...
		<div class="" id="kt_user_profile_aside" style="margin-left: 10px; margin-right: 10px;">
			<form method="post" action="/mercado-livre-nfe/gerar-venda">
				@csrf
					...
					<div class="col-md-10">
						...
						<div class="d-flex justify-content-between pt-6">
							...
							<div class="d-flex flex-column flex-root">
								...
								<span class="opacity-70">
									<a style="margin-left: 10px;" href="/clientes/edit/{{$pedido->cliente->id}}">
					...
					<div class="col-md-10">
							...
							<div class="form-group col-lg-4 col-md-6 col-sm-6">
								...
								<div class="">
									<div class="input-group date">
										<select required class="custom-select form-control" id="forma_pagamento" name="forma_pagamento">
						...
						<div class="row">
							...
							<div class="form-group validated col-sm-4 col-lg-4 col-8">
								<label class="col-form-label" id="">Tipo do frete</label>
								<select class="custom-select form-control" id="frete" name="frete">
									...
									<option value="3">3 - Própio por conta do remetente</option>
									<option value="4">4 - Própio por conta do destinatário</option>
