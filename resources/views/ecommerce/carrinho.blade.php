...
<section class="shoping-cart">
    ...
    document.getElementById("btn-calcular-frete").addEventListener("click", function() {
        alert("Cálculo de frete temporariamente desativado. Tente novamente mais tarde.");
    });
</script>
            ...
            <div class="col-lg-6">
                <div class="shoping__checkout">
                    ...
                    @if($default['config']->modelo_orcamento == true)
                    <form method="get" action="{{$rota}}/checkout" style="height: 45px">
                        <input type="hidden" id="tp_frete" value="" name="tp_frete">
                        <button class="btn primary-btn float-right w-100">FINALIZAR</button>
                    </form>
                    @else
