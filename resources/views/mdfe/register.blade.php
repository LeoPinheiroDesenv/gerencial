	...
	<div class="card-body @if(env('ANIMACAO')) animate__animated @endif animate__backInLeft">
		<div class="content d-flex flex-column flex-column-fluid" id="kt_content" >
			...
			<div class="col-lg-12" id="content">
				...
				<!--  -->
				@isset($clone)
				<input type="hidden" value="1" id="clone">
				@endif
				...
				<div class="row">
					...
					@isset($mdfe)
					{!! __view_locais_select_edit("Local", $mdfe->filial_id) !!}
					@else
					...
					<div class="form-group col-lg-2 col-md-2 col-sm-6 col-6">
						...
						<div class="">
							<div class="input-group date">
								<select class="custom-select select2-custom form-control" id="uf_inicio" name="uf_inicio">
									@foreach($ufs as $key => $u)
									<option value="{{$u}}" @isset($mdfe) @if($mdfe->uf_inicio == $u) selected @endif @else @if($config->UF == $u) selected @endif @endif>{{$u}}</option>
									@endforeach
								</select>
							</div>
						</div>
					...
					<div class="form-group col-lg-2 col-md-2 col-sm-6 col-6">
						...
						<div class="">
							<div class="input-group date">
								<select class="custom-select select2-custom form-control" id="uf_fim" name="uf_fim">
									@foreach($ufs as $key => $u)
					...
					<div class="form-group col-sm-5 col-lg-2 col-12">
					...
					<div class="form-group col-sm-3 col-lg-2 col-12">
						<label class="col-form-label">Qtd. da carga</label>
						<div class="">
							<div class="input-group">
				...
				<div class="row">
					<div class="form-group col-sm-12 col-lg-12 col-12">
						...
						<div class="card card-custom gutter-b">
							<div class="card-body">
								<h4 class="card-title">Produto Predominante</h4>
								<div class="row">
																				...
																				<div class="row align-items-center">
																					...
																					<div class="form-group col-lg-3 col-12">
																						...
																						<select class="form-control" name="motorista_id" id="motorista_id">
																							...
																							<option data-nome="{{ $m->nome }}" data-cpf="{{ $m->cpf }}" value="{{ $m->id }}">{{ $m->nome }}</option>
																							@endforeach
																						</select>
