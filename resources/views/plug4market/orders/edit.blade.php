...
<div class="card card-custom gutter-b">
    <div class="card-header">
        <div class="card-title">
            <h3 class="card-label">{{ $title ?? 'Editar Pedido Plug4Market' }}</h3>
        </div>
        <div class="card-toolbar">
            <a href="{{ route('plug4market.orders.show', $order->id) }}" class="btn btn-info btn-lg">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('plug4market.orders.update', $order->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="marketplace" name="marketplace" value="{{ $order->marketplace }}" required>
                            </div>
                            <div class="form-group">
                                <label for="status" class="form-label">Status</label>
                                <select class="form-control" id="status" name="status" required>
                                    <option value="1" {{ $order->status == 1 ? 'selected' : '' }}>Pendente</option>
                                    <option value="2" {{ $order->status == 2 ? 'selected' : '' }}>Confirmado</option>
                                    <option value="3" {{ $order->status == 3 ? 'selected' : '' }}>Enviado</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="type_billing" name="type_billing" required>
                                    <option value="PF" {{ $order->type_billing == 'PF' ? 'selected' : '' }}>Pessoa Física</option>
                                    <option value="PJ" {{ $order->type_billing == 'PJ' ? 'selected' : '' }}>Pessoa Jurídica</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" class="form-control" id="shipping_cost" name="shipping_cost" value="{{ $order->shipping_cost }}" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="payment_name" name="payment_name" value="{{ $order->payment_name }}" required>
                            </div>
                            <div class="form-group">
                                <label for="interest" class="form-label">Juros</label>
                                <input type="number" step="0.01" class="form-control" id="interest" name="interest" value="{{ $order->interest }}">
                            </div>
                            <div class="form-group">
                                <label for="total_commission" class="form-label">Comissão Total</label>
                                <input type="number" step="0.01" class="form-control" id="total_commission" name="total_commission" value="{{ $order->total_commission }}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <select class="form-control" id="cliente_id" name="cliente_id">
                            ...
                            @foreach($clientes as $cliente)
                                <option value="{{ $cliente->id }}" 
                                        {{ $order->cliente_id == $cliente->id ? 'selected' : '' }}
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="shipping_recipient_name" name="shipping_recipient_name" value="{{ $order->shipping_recipient_name }}" required>
                            </div>
                            <div class="form-group">
                                <label for="shipping_phone" class="form-label">Telefone</label>
                                <input type="text" class="form-control" id="shipping_phone" name="shipping_phone" value="{{ $order->shipping_phone }}" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="shipping_street_number" name="shipping_street_number" value="{{ $order->shipping_street_number }}" required>
                            </div>
                            <div class="form-group">
                                <label for="shipping_street_complement" class="form-label">Complemento</label>
                                <input type="text" class="form-control" id="shipping_street_complement" name="shipping_street_complement" value="{{ $order->shipping_street_complement }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="shipping_district" class="form-label">Bairro</label>
                                <input type="text" class="form-control" id="shipping_district" name="shipping_district" value="{{ $order->shipping_district }}" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="shipping_ibge" name="shipping_ibge" value="{{ $order->shipping_ibge }}">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="billing_name" name="billing_name" value="{{ $order->billing_name }}" required>
                            </div>
                            <div class="form-group">
                                <label for="billing_email" class="form-label">Email</label>
                                <input type="email" class="form-control" id="billing_email" name="billing_email" value="{{ $order->billing_email }}" required>
                            </div>
                            <div class="form-group">
                                <label for="billing_document_id" class="form-label">CPF/CNPJ</label>
                                <input type="text" class="form-control" id="billing_document_id" name="billing_document_id" value="{{ $order->billing_document_id }}" required>
                            </div>
                            <div class="form-group">
                                <label for="billing_phone" class="form-label">Telefone</label>
                                <input type="text" class="form-control" id="billing_phone" name="billing_phone" value="{{ $order->billing_phone }}" required>
                            </div>
                            <div class="form-group">
                                <label for="billing_street" class="form-label">Rua</label>
                                <input type="text" class="form-control" id="billing_street" name="billing_street" value="{{ $order->billing_street }}" required>
                            </div>
                            <div class="form-group">
                                <label for="billing_street_number" class="form-label">Número</label>
                                <input type="text" class="form-control" id="billing_street_number" name="billing_street_number" value="{{ $order->billing_street_number }}" required>
                            </div>
                            <div class="form-group">
                                <label for="billing_street_complement" class="form-label">Complemento</label>
                                <input type="text" class="form-control" id="billing_street_complement" name="billing_street_complement" value="{{ $order->billing_street_complement }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="billing_district" class="form-label">Bairro</label>
                                <input type="text" class="form-control" id="billing_district" name="billing_district" value="{{ $order->billing_district }}" required>
                            </div>
                            <div class="form-group">
                                <label for="billing_city" class="form-label">Cidade</label>
                                <input type="text" class="form-control" id="billing_city" name="billing_city" value="{{ $order->billing_city }}" required>
                            </div>
                            <div class="form-group">
                                <label for="billing_state" class="form-label">Estado</label>
                                <input type="text" class="form-control" id="billing_state" name="billing_state" value="{{ $order->billing_state }}" required>
                            </div>
                            <div class="form-group">
                                <label for="billing_zip_code" class="form-label">CEP</label>
                                <input type="text" class="form-control" id="billing_zip_code" name="billing_zip_code" value="{{ $order->billing_zip_code }}" required>
                            </div>
                            <div class="form-group">
                                <label for="billing_ibge" class="form-label">Código IBGE</label>
                                <input type="text" class="form-control" id="billing_ibge" name="billing_ibge" value="{{ $order->billing_ibge }}">
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" id="billing_tax_payer" name="billing_tax_payer">
                                    <option value="0" {{ !$order->billing_tax_payer ? 'selected' : '' }}>Não</option>
                                    <option value="1" {{ $order->billing_tax_payer ? 'selected' : '' }}>Sim</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="invoice_number" name="invoice_number" value="{{ $order->invoice_number }}" placeholder="Ex: 000001">
                            </div>
                            <div class="form-group">
                                <label for="invoice_key" class="form-label">Chave de Acesso</label>
                                <input type="text" class="form-control" id="invoice_key" name="invoice_key" value="{{ $order->invoice_key }}" placeholder="Ex: 35241234567890123456789012345678901234567890">
                            </div>
                            <div class="form-group">
                                <label for="invoice_date" class="form-label">Data da Nota Fiscal</label>
                                <input type="datetime-local" class="form-control" id="invoice_date" name="invoice_date" value="{{ $order->invoice_date ? $order->invoice_date->format('Y-m-d\TH:i') : '' }}">
                            </div>
                            <div class="form-group">
                                ...
                                @if($order->invoice_file_path)
                                    <div class="mt-2">
                                        <small class="text-info">
                                            ...
                                            Arquivo atual: <a href="{{ route('plug4market.orders.download-invoice-file', $order->id) }}" target="_blank">{{ $order->invoice_file_name ?? 'Nota Fiscal' }}</a>
                                        </small>
                                    </div>
                                @endif
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" id="invoice_status" name="invoice_status">
                                    ...
                                    <option value="pending" {{ $order->invoice_status == 'pending' ? 'selected' : '' }}>Pendente</option>
                                    <option value="processing" {{ $order->invoice_status == 'processing' ? 'selected' : '' }}>Processando</option>
                                    <option value="approved" {{ $order->invoice_status == 'approved' ? 'selected' : '' }}>Aprovada</option>
                                    <option value="rejected" {{ $order->invoice_status == 'rejected' ? 'selected' : '' }}>Rejeitada</option>
                                    <option value="cancelled" {{ $order->invoice_status == 'cancelled' ? 'selected' : '' }}>Cancelada</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="invoice_series" name="invoice_series" value="{{ $order->invoice_series }}" placeholder="Ex: 1">
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" id="invoice_model" name="invoice_model">
                                    <option value="">Selecione...</option>
                                    <option value="55" {{ $order->invoice_model == '55' ? 'selected' : '' }}>NFe - Nota Fiscal Eletrônica</option>
                                    <option value="65" {{ $order->invoice_model == '65' ? 'selected' : '' }}>NFCe - Nota Fiscal de Consumidor Eletrônica</option>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" id="invoice_environment" name="invoice_environment">
                                    <option value="">Selecione...</option>
                                    <option value="1" {{ $order->invoice_environment == '1' ? 'selected' : '' }}>Produção</option>
                                    <option value="2" {{ $order->invoice_environment == '2' ? 'selected' : '' }}>Homologação</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="invoice_protocol" class="form-label">Protocolo de Autorização</label>
                                <input type="text" class="form-control" id="invoice_protocol" name="invoice_protocol" value="{{ $order->invoice_protocol }}" placeholder="Ex: 123456789012345">
                            </div>
                            <div class="form-group">
                                <label for="invoice_protocol_date" class="form-label">Data do Protocolo</label>
                                <input type="datetime-local" class="form-control" id="invoice_protocol_date" name="invoice_protocol_date" value="{{ $order->invoice_protocol_date ? $order->invoice_protocol_date->format('Y-m-d\TH:i') : '' }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" class="form-control" id="invoice_total_products" name="invoice_total_products" value="{{ $order->invoice_total_products }}" placeholder="0.00">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="invoice_total_taxes" class="form-label">Total Impostos</label>
                                <input type="number" step="0.01" class="form-control" id="invoice_total_taxes" name="invoice_total_taxes" value="{{ $order->invoice_total_taxes }}" placeholder="0.00">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="invoice_total_shipping" class="form-label">Total Frete</label>
                                <input type="number" step="0.01" class="form-control" id="invoice_total_shipping" name="invoice_total_shipping" value="{{ $order->invoice_total_shipping }}" placeholder="0.00">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="invoice_total_discount" class="form-label">Total Desconto</label>
                                <input type="number" step="0.01" class="form-control" id="invoice_total_discount" name="invoice_total_discount" value="{{ $order->invoice_total_discount }}" placeholder="0.00">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" class="form-control" id="invoice_total_final" name="invoice_total_final" value="{{ $order->invoice_total_final }}" placeholder="0.00">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-bordered" id="produtos-table">
                            ...
                            <tbody>
                                @foreach($order->items as $index => $item)
                                    <tr id="produto-row-{{ $index + 1 }}">
                                        <td>
                                            <select class="form-control produto-select" name="produtos[{{ $index + 1 }}][id]" onchange="selecionarProduto(this, {{ $index + 1 }})">
                                        ...
                                        <td>
                                            <input type="text" class="form-control" name="produtos[{{ $index + 1 }}][sku]" id="sku-{{ $index + 1 }}" value="{{ $item->sku }}" readonly>
                                        </td>
                                        <td>
                                            <input type="number" step="0.01" class="form-control" name="produtos[{{ $index + 1 }}][preco]" id="preco-{{ $index + 1 }}" value="{{ $item->price }}" readonly>
                                        </td>
                                        <td>
                                            <input type="number" class="form-control" name="produtos[{{ $index + 1 }}][quantidade]" id="quantidade-{{ $index + 1 }}" value="{{ $item->quantity }}" min="1" onchange="calcularTotal({{ $index + 1 }})">
                                        </td>
                                        <td>
                                            <input type="number" step="0.01" class="form-control" id="total-{{ $index + 1 }}" value="{{ $item->total_price }}" readonly>
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-danger btn-sm" onclick="removerProduto({{ $index + 1 }})">
            ...
            <div class="card card-custom">
                <div class="card-body">
                    <div class="d-flex justify-content-end">
                        ...
                        <a href="{{ route('plug4market.orders.show', $order->id) }}" class="btn btn-secondary btn-lg ml-3">
...
<script>
let produtoCounter = {{ $order->items->count() }};
