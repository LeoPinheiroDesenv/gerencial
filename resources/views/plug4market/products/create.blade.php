...
<div class="card card-custom gutter-b">
    <div class="card-header">
        <div class="card-title">
            <h3 class="card-label">{{ $title ?? 'Novo Produto Plug4Market' }}</h3>
        </div>
    ...
    <div class="card-body">
        <form action="{{ route('plug4market.products.store') }}" method="POST">
            @csrf
                        ...
                        <select name="categoria_id" 
                            ...
                            @foreach($categories as $category)
                                <option value="{{ $category->external_id }}" 
                                        {{ old('categoria_id') == $category->external_id ? 'selected' : '' }}>
            ...
            <div class="alert alert-info">
                ...
                <strong>Informação:</strong> O produto será criado localmente e automaticamente sincronizado com a API Plug4Market.
            </div>

            <div class="form-group">
                <button type="submit" class="btn btn-primary btn-lg">
                    <i class="fa fa-save"></i> Criar Produto
                </button>
                <a href="{{ route('plug4market.products.index') }}" class="btn btn-secondary btn-lg">
