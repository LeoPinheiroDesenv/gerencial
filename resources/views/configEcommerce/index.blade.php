							...
							<div class="kt-section kt-section--first">
								<div class="kt-section__body">
									<div class="row">
										<div class="form-group validated col-sm-6 col-lg-6 col-12">
											...
											<div class="">
												...
												@endif
												<p class="text-danger">Exemplo Loja Owner</p>
											</div>
										</div>
										...
										<div class="form-group validated col-sm-6 col-lg-6 col-12">
											...
											<div class="">
												...
												@endif
												<p class="text-danger">Exemplo Owner</p>
											</div>
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="form-group validated col-sm-6 col-lg-2 col-12">
											<label class="col-form-label">Modelo orçamento</label>
											<div class="">
												<span class="switch switch-outline switch-danger">
													<label>
														<input value="true" @if(isset($config) && $config->modelo_orcamento) checked @endif type="checkbox" name="modelo_orcamento" id="modelo_orcamento">
														<span></span>
													</label>
												</span>
											</div>
									...
									<div class="row">
										...
										<div class="form-group validated col-sm-4 col-lg-4 col-6">
											...
											<select required id="formas_pagamento" name="formas_pagamento[]" required class="form-control select2-custom" multiple>
												@foreach(App\Models\ConfigEcommerce::formasPagamento() as $key => $f)
												<option @isset($config) @if(in_array($key, json_decode($config->formas_pagamento ?? '[]'))) selected @endif @endif value="{{ $key }}">{{ $f }}</option>
												@endforeach
											</select>
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="form-group validated col-sm-5 col-lg-5 col-6 use-api @if(env('ANIMACAO')) animate__animated @endif animate__backInLeft" style="display: none">
										...
										<div class="form-group validated col-sm-12 col-lg-12 col-12 use-api @if(env('ANIMACAO')) animate__animated @endif animate__backInLeft" style="visibility: hidden">
										...
										<div class="form-group col-sm-3 col-lg-3 col-6 use-api @if(env('ANIMACAO')) animate__animated @endif animate__backInLeft">
										...
										<div class="form-group @if(env('ANIMACAO')) animate__animated @endif animate__backInLeft validated col-sm-4 col-lg-4 col-6 use-api" style="display: none">
										...
										<div class="form-group validated col-sm-4 col-lg-4 col-6 use-api @if(env('ANIMACAO')) animate__animated @endif animate__backInLeft" style="display: none">
									...
									<div class="row">
										...
										<div class="form-group validated col-sm-6 col-lg-4 col-12 template no-api">
					...
					<div class="card-footer">
						<div class="row">
							...
							<div class="col-lg-3 col-sm-6 col-md-4">
								<a style="width: 100%" class="btn btn-danger" href="/configEcommerce">
