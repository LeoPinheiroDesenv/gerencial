    ...
    <div class="login login-2 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login" style="margin-top: -50px;">
            ...
            <div class="login-form login-signin py-11">
              ...
              <form method="post" action="/login/request" class="form animate__animated animate__backInDown" novalidate="novalidate" id="kt_login_signin_form">
                ...
                <div class="form-group">
                  ...
                  <input autofocus id="login" @if(session('login') != null) value="{{ session('login') }}" @else @if(isset($loginCookie)) value="{{$loginCookie}}" @endif @endif name="login" class="form-control form-control-solid h-auto py-7 px-6 rounded-lg" type="text" autocomplete="off" />
                </div>
                <!--end::Form group-->
                <!--begin::Form group-->
                <div class="form-group">
                  ...
                  <input name="senha" id="senha" class="form-control form-control-solid h-auto py-7 px-6 rounded-lg" type="password" autocomplete="off" @if(isset($senhaCookie)) value="{{$senhaCookie}}" @endif />
                </div>
                ...
                <button type="button" class="btn btn-success mb-2" onclick="doLogin('Owner', '12345')">
                  Super Admin
                </button>
                <button type="button" class="btn btn-info mb-2" onclick="doLogin('admin', '12345')">
                  Adiministrador
                </button>
                @endif
      ...
      <div class="content order-1 order-lg-2 d-flex flex-column w-100 pb-0 stk" style="background-color: #FFF">
        ...
        <div class="d-flex flex-column justify-content-center text-center pt-lg-40 pt-md-5 pt-sm-5 px-lg-0 pt-5 px-7">
          <h3 class="display4 font-weight-bolder my-7 text-dark" style="color: #986923;">{{env("APP_NAME")}}</h3>
          <p class="font-weight-bolder font-size-h2-md font-size-lg text-dark opacity-70">{{env("APP_DESC")}}</p>
        </div>
        <!--end::Title-->
        <!--begin::Image-->
