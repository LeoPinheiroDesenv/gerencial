					...
					<div class="d-flex flex-column-fluid flex-column" >
						...
						<div class="login-form login-signin py-2">
							...
							<div class="text-center pb-8">
								<h2 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">{!! env("TITUO_PLANO") !!}</h2>

								@if(env("MENSAGEM_PLANO"))
								<h4>{!! env("MENSAGEM_PLANO") !!}</h4>
								@endif
								@if(env("PLANO_AUTOMATICO_DIAS") > 0)
								<p class="text-info">*Faça seu cadastro, e utilize grátis por {{env("PLANO_AUTOMATICO_DIAS")}} dia(s)</p>
								@endif
