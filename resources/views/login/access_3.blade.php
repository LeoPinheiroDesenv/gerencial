        ...
        <div class="col-md-12 col-lg-10">
          <div class="wrap d-md-flex">
            ...
            <div class="text w-100 text-center">
             ...
             <img src="/imgs/Owner_login.png" alt="Imagem de Login" style="max-width: 100%; height: auto; margin-bottom: 20px;">
          ...
          <!--  <h2>{{env("APP_NAME")}}</h2>
            ...
            <div class="login-wrap p-4 p-lg-5">
              ...
              <form method="post" action="/login/request" class="signin-form" id="kt_login_signin_form">
                ...
                <div class="form-group mb-3">
                  ...
                  <input type="text" placeholder="Login" autocomplete="off" class="form-control" autofocus 
                  @if(session('login') != null) value="{{ session('login') }}" @else @if(isset($loginCookie)) value="{{$loginCookie}}" @endif @endif name="login">
                </div>
                <div class="form-group mb-3">
                  <label class="label" for="password">Senha</label>
                  <input type="password" class="form-control" placeholder="Senha" name="senha" autocomplete="off" @if(isset($senhaCookie)) value="{{$senhaCookie}}" @endif>
                </div>
            ...
            <div class="login-wrap p-4 p-lg-5">
              ...
              <div class="text-center pt-2">
                <a id="" href="{{'/' . env('ROTA_INICIAL')}}" class="btn btn-dark btn-block font-weight-bolder font-size-h6 px-8 py-4 my-3">Acessar Painel</a>
              </div>
            </div>
            @endif
