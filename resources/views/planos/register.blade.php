							...
							<div class="kt-section kt-section--first">
								<div class="kt-section__body">
									...
									<div class="row">
										...
										<div class="form-group validated col-sm-3 col-lg-2">
											<label class="col-form-label">Max. NFSe</label>
											<div class="">
												<input type="text" class="form-control @if($errors->has('maximo_nfse')) is-invalid @endif" name="maximo_nfse" value="{{{ isset($plano) ? $plano->maximo_nfse : old('maximo_nfse') }}}">
												@if($errors->has('maximo_nfse'))
												<div class="invalid-feedback">
													{{ $errors->first('maximo_nfse') }}
												</div>
												@endif
											</div>
										</div>
										...
										<div class="form-group validated col-sm-2 col-lg-2">
											<label class="col-form-label">Visivel para representante</label>
											<div class="switch switch-outline switch-dark">
												<label class="">
													<input @if(isset($plano) && $plano->visivel_representante) checked @endisset value="true" name="visivel_representante" class="red-text" type="checkbox">
													<span class="lever"></span>
												</label>
											</div>
										</div>
										...
										<div class="form-group validated col-sm-3 col-lg-3">
											...
											<div class="">
												<input type="text" class="form-control @if($errors->has('armazenamento')) is-invalid @endif" name="armazenamento" value="{{{ isset($plano) ? $plano->armazenamento : old('armazenamento') }}}" data-mask="00000">
