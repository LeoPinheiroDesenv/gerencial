...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
	...
	<input type="hidden" id="auto_bind_barcode" value="{{ old('auto_bind_barcode', isset($atalhos) && $atalhos->auto_bind_barcode ? 1 : 0) }}">
							...
							<div class="row align-items-center" style="margin-top: 10px;width:100%">
								...
								<div class="form-group validated col-sm-6 col-lg-6 col-12 col-sm-12 add-prod">
									...
									<div class="input-group">
                                        <!-- Campo Select2 para a busca do produto -->
								...
								<div class="row">
									<div class="col-xl-12">
										<div id="kt_datatable" class="datatable datatable-bordered datatable-head-custom datatable-default datatable-primary datatable-loaded" >
											...
											<table class="datatable-table" style="max-width: 100%; max-height: 420px; overflow: auto;">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
		...
		<script type="text/javascript" src="/js/frentecaixaVarejo.js"></script>
