	...
	<div class="card-body @if(env('ANIMACAO')) animate__animated @endif animate__backInRight">
		<div class="content d-flex flex-column flex-column-fluid" id="kt_content" >
			...
			<div class="col-lg-12" id="content">
				...
				@if(isset($cotacao) && $cotacao != null)
				<input type="hidden" value="{{json_encode($cotacao->itens)}}" id="itens_cotacao">
				@endif
					...
					<div class="col-xl-12">
						...
						<div class="kt-section kt-section--first">
							<div class="kt-section__body">
								@if(!empresaComFilial())
								<div class="row">
									<h3 class="col-12">Novo Orçamento</h3>
									@if(isset($cotacao) && $cotacao != null)
									<input type="hidden" id="cotacao_id" value="{{ $cotacao->id }}">
									<div class="col-12">
										<h5>Gerando venda a partir da cotação: <strong class="text-info">#{{ $cotacao->link }}</strong></h5>
									</div>
									@endif
										...
										<div class="">
											<div class="input-group date">
												<select class="custom-select form-control" id="natureza" name="natureza">
													...
													selected
													@endif
													value="{{$n->id}}" data-movimenta_estoque="{{ $n->nao_movimenta_estoque }}">{{$n->natureza}}</option>
													@endforeach
												</select>
											</div>
										</div>
					...
					<div class="card-body">
						...
						<div class="row">
							...
							<div class="col-sm-6 col-lg-6 col-md-6 col-xl-6 col-12">
								<a id="salvar-orcamento" style="width: 100%;" href="#" onclick="salvarOrcamento()" class="btn btn-primary disabled">Salvar Orçamento</a>
							</div>
...
@endsection
@section('javascript')
<script type="text/javascript" src="/js/orcamento_register.js"></script>
@endsection
