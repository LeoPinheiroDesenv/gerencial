	...
	<div class="card-body">
		<div class="content d-flex flex-column flex-column-fluid" id="kt_content" >
			...
			<div class="col-lg-12" id="content">
				...
				<input type="hidden" value="{{json_encode($orcamento)}}" id="venda_edit" name="">
						...
						<div class="kt-section kt-section--first">
							<div class="kt-section__body">
								...
								<div class="row">
									...
									{!! __view_locais_select_edit("Local", $orcamento->filial_id) !!}
									...
									<div class="form-group validated col-sm-7 col-lg-8 col-12">
										...
										<div class="input-group">
											...
											<select class="form-control select2" id="kt_select2_3" name="cliente">
												...
												<option @if($orcamento->cliente_id == $c->id) selected @endif value="{{$c->id}}">{{$c->id}} - {{$c->razao_social}}/{{$c->nome_fantasia}} ({{$c->cpf_cnpj}})</option>
												@endforeach
											</select>
														...
														<table class="datatable-table" style="max-width: 100%; overflow: scroll;" id="prod">
															<thead class="datatable-head">
																<tr class="datatable-row" style="left: 0px;">
																	<th data-field="OrderID" class="datatable-cell datatable-cell-sort"><span style="width: 40px;">Item</span></th>
																	<th data-field="OrderID" class="datatable-cell datatable-cell-sort"><span style="width: 50px;">Cód Prod</span></th>
																	<th data-field="OrderID" class="datatable-cell datatable-cell-sort"><span style="width: 210px;">Nome</span></th>
																	<th data-field="Country" class="datatable-cell datatable-cell-sort"><span style="width: 100px;">Qtd.</span></th>
																	<th data-field="ShipDate" class="datatable-cell datatable-cell-sort"><span style="width: 80px;">Vlr. Original</span></th>
																	<th data-field="ShipDate" class="datatable-cell datatable-cell-sort"><span style="width: 100px;">Desc.</span></th>
																	<th data-field="ShipDate" class="datatable-cell datatable-cell-sort"><span style="width: 80px;">Vlr. com Desc.</span></th>

																	<th data-field="CompanyName" class="datatable-cell datatable-cell-sort"><span style="width: 80px;">Subtotal</span></th>
																...
																<div class="form-group validated col-sm-6 col-lg-7 col-12">
																	<div class="input-group">
																		...
																		<select class="form-control select2" id="kt_select2_2" style="width: 80%;" name="transportadora">
																			...
																			<option 
																			@if($orcamento->transportadora_id == $t->id)
																			selected
																			@endif
														...
														<div class="col-xl-12">
															...
															<div class="row align-items-center">
																...
																<div class="form-group col-lg-2 col-md-4 col-sm-6 col-6">
																	...
																	<div class="">
																		<div class="input-group">
																			<input type="text" name="placa" class="form-control" value="@if($orcamento->frete != null) {{$orcamento->frete->placa}} @endif" id="placa"/>
																		</div>
																	</div>
																</div>
																...
																<div class="form-group validated col-sm-2 col-lg-2 col-6">
																	...
																	<select class="custom-select form-control" id="uf_placa" name="uf_placa">
																		...
																		<option @if($orcamento->frete != null) @if($orcamento->frete->uf == $e) selected @endif @endif value="{{$e}}">{{$e}}</option>
																		@endforeach
																	</select>
																</div>
																...
																<div class="form-group col-lg-2 col-md-4 col-sm-6 col-6">
																	...
																	<div class="">
																		<div class="input-group">
																			<input type="text" name="valor_frete" class="form-control" value="@if($orcamento->frete != null) {{$orcamento->frete->valor}} @endif" id="valor_frete"/>
																		</div>
																	</div>
																</div>
															</div>
														...
														<div class="col-xl-12">
															...
															<div class="row align-items-center">
																...
																<div class="form-group col-lg-3 col-md-4 col-sm-6 col-6">
																	...
																	<div class="">
																		<div class="input-group">
																			<input type="text" name="especie" class="form-control" value="@if($orcamento->frete != null) {{$orcamento->frete->especie}} @endif" id="especie"/>
																		</div>
																	</div>
																</div>
																...
																<div class="form-group col-lg-3 col-md-4 col-sm-6 col-6">
																	...
																	<div class="">
																		<div class="input-group">
																			<input type="text" name="numeracaoVol" class="form-control" value="@if($orcamento->frete != null) {{$orcamento->frete->numeracaoVolumes}} @endif" id="numeracaoVol"/>
																		</div>
																	</div>
																</div>
																...
																<div class="form-group col-lg-3 col-md-4 col-sm-6 col-6">
																	...
																	<div class="">
																		<div class="input-group">
																			<input type="text" name="qtdVol" class="form-control" value="@if($orcamento->frete != null) {{$orcamento->frete->qtdVolumes}} @endif" id="qtdVol"/>
																		</div>
																	</div>
																</div>
																...
																<div class="form-group col-lg-3 col-md-4 col-sm-6 col-6">
																	...
																	<div class="">
																		<div class="input-group">
																			<input type="text" name="pesoL" class="form-control" value="@if($orcamento->frete != null) {{$orcamento->frete->peso_liquido}} @endif" id="pesoL"/>
																		</div>
																	</div>
																</div>
																...
																<div class="form-group col-lg-3 col-md-4 col-sm-6 col-6">
																	...
																	<div class="">
																		<div class="input-group">
																			<input type="text" name="pesoB" class="form-control" value="@if($orcamento->frete != null) {{$orcamento->frete->peso_bruto}} @endif" id="pesoB"/>
																		</div>
																	</div>
																</div>
															</div>
																		...
																		<div class="row">
																			<div class="form-group validated col-sm-12 col-lg-12 col-12">
																				...
																				<select class="custom-select form-control" id="tipoPagamento" name="tipoPagamento">
																					...
																					<option 
																					@if($orcamento->tipo_pagamento == $key)
																					selected
																					@endif
					...
					<div class="card-body">
						<div class="row">
							...
							<div class="col-xl-3 col-sm-6 col-6">
								...
								<div class="input-group">
									<div class="input-group-prepend">
										<div class="">
											<input type="text" name="data_entrega" class="form-control date-input" value="@if($orcamento->data_entrega != null) {{\Carbon\Carbon::parse($orcamento->data_entrega)->format('d/m/Y')}} @endif" id="data_entrega"/>
										</div>
									</div>
								</div>
							</div>
							<div class="col-xl-3 col-sm-6 col-6">
								...
								<div class="input-group">
									<div class="input-group-prepend">
										<div class="">
											<input type="text" name="data_retroativa" class="form-control date-input" value="@if($orcamento->data_retroativa != null) {{\Carbon\Carbon::parse($orcamento->data_retroativa)->format('d/m/Y')}} @endif" id="data_retroativa"/>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-sm-8 col-lg-8 col-md-12 col-xl-5">
								<div class="form-group col-lg-12 col-md-12 col-sm-12 col-12">
									...
									<div class="">
										<div class="input-group">
											<input type="text" name="obs" class="form-control" value="{{$orcamento->observacao}}" id="obs"/>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-sm-6 col-lg-6 col-md-6 col-xl-6 col-12">
								<a style="width: 100%;" href="#" onclick="gerarVenda('nfe')" class="btn btn-info disabled btn-finish">Gerar Venda</a>
							</div>

							<div class="col-sm-6 col-lg-6 col-md-6 col-xl-6 col-12">
								<a style="width: 100%;" href="#" onclick="atualizarOrcamento('nfe')" class="btn btn-success disabled btn-finish">Atualizar Orçamento</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="form-group validated col-sm-3 col-lg-3 col-6">
						...
						<select class="custom-select" id="bandeira_cartao">
							...
							<option
							@if($orcamento->bandeira_cartao == $key)
							selected
							@endif
							value="{{$key}}">{{$b}}</option>
							@endforeach
					...
					<div class="form-group validated col-sm-4 col-lg-4 col-6">
						...
						<input value="{{$orcamento->cAut_cartao}}" type="text" placeholder="Código autorização" id="cAut_cartao" class="form-control" value="">
					</div>

					<div class="form-group validated col-sm-4 col-lg-5 col-12">
						<label class="col-form-label">CNPJ(opcional)</label>
						<input value="{{$orcamento->cnpj_cartao}}" type="text" placeholder="CNPJ" id="cnpj_cartao" data-mask="00.000.000/0000-00" name="cnpj_cartao" class="form-control" value="">
					</div>
				</div>
...
@endsection
@section('javascript')
<script type="text/javascript" src="/js/orcamento_edit.js"></script>
@endsection