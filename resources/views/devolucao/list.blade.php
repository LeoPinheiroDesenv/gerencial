...
<div class="card card-custom gutter-b">
	<div class="card-body">
		...
		<div class="" id="kt_user_profile_aside" style="margin-left: 10px; margin-right: 10px;">
			...
			<form class="@if(env('ANIMACAO')) animate__animated @endif animate__backInLeft" method="get" action="/devolucao/filtro">
			...
			<br>
			<h4 class="@if(env('ANIMACAO')) animate__animated @endif animate__backInLeft">Lista de Devoluções</h4>

			<a href="/devolucao/nova" class="btn btn-light-danger @if(env('ANIMACAO')) animate__animated @endif animate__backInLeft">
									...
									<div class="row">
												...
												<table class="datatable-table" style="max-width: 100%; overflow: scroll">
													...
													<tbody id="body" class="datatable-body">
														...
														<tr class="datatable-row">
															...
															<td class="datatable-cell"><span class="codigo" style="width: 100px;">{{ number_format($d->valor_integral, $casasDecimais, ',', '.') }}</span>
															</td>
															<td class="datatable-cell"><span class="codigo" style="width: 100px;">{{ number_format($d->valor_devolvido, $casasDecimais, ',', '.') }}</span>
															</td>
															...
															<td>
																<div class="row">
																	<span style="width: 280px;">
																		...
																		<a class="btn btn-danger btn-sm" onclick='swal("Atenção!", "Deseja remover este registro?", "warning").then((sim) => {if(sim){ location.href="/devolucao/delete/{{$d->id}}" }else{return false} })' 
																			href="#!">
																			<i class="la la-trash"></i>	
																		</a>

																		<a class="btn btn-warning btn-sm" onclick='swal("Atenção!", "Deseja editar este registro?", "warning").then((sim) => {if(sim){ location.href="/devolucao/edit/{{$d->id}}" }else{return false} })' 
																			href="#!">
																			<i class="la la-edit"></i>	
																		</a>

																		<a class="btn btn-dark btn-sm" onclick='swal("Atenção!", "Deseja editar este registro?", "warning").then((sim) => {if(sim){ location.href="/devolucao/editManual/{{$d->id}}" }else{return false} })' 
																			href="#!">
																		...
																		@if($d->estado == 1)
																		<a class="btn btn-info btn-sm" href="/devolucao/ver/{{$d->id}}">
																			<i class="la la-file"></i>
																		</a>
																		@endif

																		<a title="Alterar Estado Fiscal" class="btn btn-primary btn-sm"
																			href="/devolucao/estadoFiscal/{{$d->id}}">
																			<i class="la la-file"></i>	
																		</a>
																	</span>
																</div>
										...
										<div class="col-sm-12 col-lg-12 col-md-12 col-xl-12">
											...
											<div class="row" style="margin-top: 5px;">
												...
												<div class="col-sm-4 col-lg-4 col-md-4 col-xl-2 col-6">
													<a id="btn-xml" onclick="setarNumero(true)" style="width: 100%" class="btn btn-primary" data-toggle="modal" data-target="#modal5">Enviar Email</a>
												</div>
											...
											<div class="card card-custom gutter-b example example-compact">
												...
												<div class="card-body">
													...
													<div class="row">
														...
														<div class="col-sm-12 col-lg-12 col-md-12 col-xl-6">
															<a id="btn_transmitir_grid_{{$d->id}}" style="width: 100%; margin-top: 5px;" onclick='swal("Atenção!", "Deseja editar este registro?", "warning").then((sim) => {if(sim){ location.href="/devolucao/edit/{{$d->id}}" }else{return false} })' href="#!" class="btn btn-warning">
																<i class="la la-edit"></i>
																Editar
															</a>
														</div>
...
<div class="modal fade" id="modal5" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">ENVIAR XML DEVOLUÇÃO #<strong class="text-danger" id="numero_nf"></strong></h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					x
				</button>
			</div>
			<div class="modal-body">
				...
				<input type="hidden" id="devolucao_id">
