...
<div class="row" id="anime" style="display: none">
	<div class="col s8 offset-s2">
		<lottie-player 
		src="/anime/{{\App\Models\Venda::randSuccess()}}" background="transparent" speed="0.8"  style="width: 100%; height: 300px;" autoplay >
	</lottie-player>
</div>
</div>
	...
	<div class="card-body">
						...
						<table class="datatable-table" style="max-width: 100%; overflow: scroll">
							...
							<tbody id="body" class="datatable-body">
								...
								<tr class="datatable-row">
									...
									<td class="datatable-cell"><span class="codigo" style="width: 100px;">{{ moeda($i->quantidade * $i->valor_unit) }}</span>
									</td>
		...
		<div class="card card-custom gutter-b">
			<div class="card-body">
				<div class="row">
					<div class="col s6">
						<h4>Valor Integral da NF: <strong id="valorDaNF" class="blue-text">R$ {{ moeda((float)$dadosNf['vProd']) }}</strong></h4>
					</div>

					<div class="col s6">
						<h4>Valor Devolvido: <strong class="red-text">R$ {{ moeda($devolucao->valor_devolvido) }}</strong></h4>
					</div>
