...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        fetch("/sangriaCaixa/diaria") // Ajuste a URL conforme necessário
        .then(response => response.json())
        .then(data => {
            console.log("🚀 Sangrias Recebidas:", data.sangrias);
            console.log("🔍 Logs Laravel:", data.logs);

            if(data.logs) {
                console.group("📢 Debug Laravel Logs");
                console.log("🧑 Usuário logado:", data.logs["Usuário logado"]);
                console.log("🏢 Empresa ID:", data.logs["Empresa ID"]);
                console.log("📦 Abertura Caixa:", data.logs["Abertura Caixa"]);
                console.log("💰 Sangrias:", data.logs["Sangrias encontradas"]);
                console.groupEnd();
            }
        })
