...
<body>
	...
	<table>
		<tr>
			<td class="" style="width: 233px;">
				Total de Abertura: <strong>{{number_format($abertura->valor, 2, ',', '.')}}</strong>
			</td>
			<td class="" style="width: 233px;">
	...
	<table>
		...
		<tr>
			<td class="b-bottom" style="width: 233px;">
				Valor em caixa: <strong>R$ {{ number_format($valorEmDinheiro + $abertura->valor + $somaSuprimento - $somaSangria, 2, ',', '.') }}</strong>
			</td>
			<td class="b-bottom" style="width: 233px;">
				Contagem da gaveta: <strong>R$ {{number_format($abertura->valor_dinheiro_caixa, 2, ',', '.')}}</strong>
			</td>
			<td class="b-bottom" style="width: 233px;">
				Diferença: <strong> R$ {{ number_format($abertura->valor_dinheiro_caixa - ($valorEmDinheiro + $abertura->valor + $somaSuprimento - $somaSangria), 2, ',', '.') }}</strong>
			</td>
		</tr>
