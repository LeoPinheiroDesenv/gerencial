								...
								<div class="col-sm-12 col-lg-12 col-md-12 col-xl-12">
									<div class="card card-custom gutter-b example example-compact">
										<div class="card-">
											...
											<div class="card-body">
												<h3 class="card-">Total em estoque compra: <strong style="margin-left: 3px;" class="text-danger">R$ {{ moeda($totaliza['compra']) }}</strong></h3>

												<h3 class="card-">Total em estoque venda: <strong style="margin-left: 3px;" class="text-success"> R${{ moeda($totaliza['venda']) }}</strong></h3>
